...
#else
// Keep hash inputs inside mediump's guaranteed 卤2^14 range.
...
vec3 linearToSrgb(vec3 c) {
  ...
  // channel negative, and pow(negative, 鈥? is NaN which mix()/step() would
...
void main() {
  ...
  // Cursor modes 1鈥? are local distortions. Push shifts the same screen-space
